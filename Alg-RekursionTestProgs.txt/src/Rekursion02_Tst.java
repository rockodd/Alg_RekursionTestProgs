	class Rekursion02_Tst {
	   ...
	   static public int anz_10_er_Ziffern(int n) {
		   if(n<10) return 1;
		   return 1+anz_10_er_Ziffern(n/10);
	   }
	   // ---------------------------------------------------------------------
	   ...
	   static private void tst_zehner_Ziffer() {
	      tst("zehner_Ziffer",  3, zehner_Ziffer(   3,  0),    3,  0);
	      tst("zehner_Ziffer",  0, zehner_Ziffer(   3,  1),    3,  1);
	      tst("zehner_Ziffer",  0, zehner_Ziffer(   3,  2),    3,  2);
...
//	       tst_als_b_er_Zahl();
	...
	Rekursion02: Jetzt geht es los!
	---------------------------------+--------------------+
	Aufruf der zu testenden Funktion | Ist-Erg.|Soll-Erg  |
	---------------------------------+---------+----------+
	zehner_Ziffer(3,0)                        3|3          OK
	zehner_Ziffer(3,1)                        0|0          OK
	zehner_Ziffer(3,2)                        0|0          OK
